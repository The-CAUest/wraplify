import { v4 as uuid } from "uuid";
  ...
  function NoteCreate({ initialValue = {} ,onCreate, inputColumn, style = {} }) {
    const initialState = {
      lists: [],
      loading: true,
      error: false,
      form: { id: "",name: "",completed: false,date: "",url: "",age: 0,},
    };
    ...
    let data = schema["Note"];
  
    return (
      <div style={{ ...styles.container, ...style }}>
        <Form onFinish={createNote}>
